...
public class CloneTest {
    ...
    public static void main(String[] args) {
        ...
        int count = 0;
        CosmosN cosmosN1 = new CosmosN();
        CosmosN cosmosN2 = new CosmosN();
        CosmosN cosmosN3 = new CosmosN();
        CosmosN cosmosN4 = new CosmosN();
        CosmosN cosmosN5 = new CosmosN();
        CosmosN cosmosN6 = new CosmosN();
        CosmosN cosmosN7 = new CosmosN();
        CosmosN cosmosN8 = new CosmosN();
        int countSize = 100000;

        //1.使用org.apache.commons.beanutils.BeanUtils.copyProperties(Object dest, Object orig);
        Long start1 = System.currentTimeMillis();

        while (count < countSize * 1) {
        ...
        net.sf.cglib.beans.BeanCopier beanCopier3 = net.sf.cglib.beans.BeanCopier.create(CosmosY.class, CosmosN.class, false);

        while (count < countSize * 3) {
            cosmosN3 = new CosmosN();
            beanCopier3.copy(cosmosY, cosmosN3, null);
            count++;
        }
        ...
        org.springframework.cglib.beans.BeanCopier beanCopier4 = BeanCopier.create(CosmosY.class, CosmosN.class, false);

        while (count < countSize * 4) {
            cosmosN4 = new CosmosN();
            beanCopier4.copy(cosmosY, cosmosN4, null);
            count++;
        }
        ...
        while (count < countSize * 6) {
            cosmosN6 = new CosmosN();
            for (Field field : fields6) {
                try {
                    Field fieldY = cosmosY.getClass().getDeclaredField(field.getName());
                    fieldY.setAccessible(true);
                    field.setAccessible(true);
                    field.set(cosmosN6, fieldY.get(cosmosY));
                } catch (IllegalAccessException e) {
                    e.printStackTrace();
                } catch (NoSuchFieldException e) {
                    e.printStackTrace();
        ...
        while (count < countSize * 8) {
            cosmosN8 = new CosmosN();
            copyProperties(cosmosY, cosmosN8);
            count++;
        }
        Long end8 = System.currentTimeMillis();
        long spend8 = end8 - start8;
        ...
        System.out.println("6.使用自写反射 ,耗时:" + spend6 + " ms");
        System.out.println("7.使用json序列化 ,耗时:" + spend7 + " ms");
        System.out.println("8.BeanUtils.copyProperties ,耗时:" + spend8 + " ms");
